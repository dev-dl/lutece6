 ...
 */
final class Version20210508172210 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE candidate (id INT NOT NULL, state VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('ALTER TABLE "position" ALTER title SET NOT NULL');
        $this->addSql('ALTER TABLE "position" ALTER action SET NOT NULL');
        $this->addSql('ALTER TABLE "position" ALTER slug DROP NOT NULL');
    }
